 ...
 * @return {Array} Local resources to be updated in the remote server
*/
 ...
 * @param {Array} localResources Local resources
 * @param {Array} remoteResources Remote resources
 * @return {Array} Local resources to be created in the remote server
*/
 ...
 * @param {Array} localResources Local resources
 * @param {Array} remoteResources Remote resources
 * @return {Array} Remote resources to be delete from the remote server
*/
 ...
 * @param {Array} a Array
 * @param {Array} b Array
 * @return {number} Array sorted from root to bottom
*/
 ...
 * @param {Array} a Array
 * @param {Array} b Array
 * @return {number} Array sorted from bottom to the root
*/
